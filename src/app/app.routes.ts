...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'paramedic/:id', loadComponent: () => import('../Paramedics/Paramedic Profile/web-cases-cardprofile/web-cases-cardprofile.component').then(m => m.WebCasesCardprofileComponent) },
